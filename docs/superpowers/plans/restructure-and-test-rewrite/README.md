...
| ⏳ | **30** | Admin large split P1 — PeriodsPage 1765 + OrganizationsPage 1712 (Table/MobileCards/OrgTable/UnlockRequestsPanel) | 2 page + ~7 yeni komponent | ~3h | %80 | S31 için aynı pattern |
