...
Steps 5 and 6 include both desktop and mobile-portrait screenshots to show that the full evaluation flow works on any device.

---

## 1. Identity

![Identity form — juror enters name and affiliation](_images/jury/01-identity.png)
...
![PIN entry screen for a returning juror](_images/jury/02-pin.png)
...
- PINs are short numeric codes displayed to the juror on their first entry (see screen 3).
...
![PIN reveal screen — new juror sees their PIN for the first time](_images/jury/03-pin-reveal.png)
...
![Progress check — project list with evaluation status](_images/jury/04-progress.png)
...
![Scoring form for one project — desktop viewport](_images/jury/05-evaluate.png)

**Mobile portrait (390 × 844):**

![Scoring form for one project — mobile portrait viewport](_images/jury/05-evaluate-mobile.png)
...
![Evaluation complete — all criteria scored, submit enabled](_images/jury/06-complete.png)

**Mobile portrait (390 × 844):**

![Evaluation complete — mobile portrait viewport](_images/jury/06-complete-mobile.png)
