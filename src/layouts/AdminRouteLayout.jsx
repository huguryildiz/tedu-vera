...
const LazyPendingReviewGate = lazy(() => import("@/auth/features/pending-review/PendingReviewScreen"));
const LazyGraceLockScreen   = lazy(() => import("@/auth/features/grace-lock/GraceLockScreen"));
