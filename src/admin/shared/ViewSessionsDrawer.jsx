            ...
            <div key={session.id} className={`fs-session-card${isCurrent ? " current" : ""}`}>
              ...
              <div className="fs-session-card-body">
                ...
                <div className="fs-session-card-meta">
                  <div>
                    Signed in: <span className="vera-datetime-text" style={{ marginLeft: 4 }}>{formatAbsoluteDate(signedInAt)}</span>
                  ...
                  <div>Last active: <span className="vera-datetime-text" style={{ marginLeft: 4 }}>{formatRelative(session?.last_activity_at)}</span></div>
                </div>
              </div>
