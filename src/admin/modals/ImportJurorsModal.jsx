...
// Modal: preview and confirm CSV import of jurors.
//
// Props:
//   open            — boolean
//   onClose         — () => void
//   file            — { name: string, sizeLabel: string } | null
//   rows            — [{ rowNum, name, affiliation, status: "ok"|"skip"|"err", statusLabel }]
...
export default function ImportJurorsModal({
  ...
  return (
    <Modal open={open} onClose={onClose} size="xl">
        ...
        <div className="fs-modal-header-row">
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div className="fs-title-group">
              ...
              <div className="fs-subtitle">Upload a CSV with juror names, affiliations and contact details.</div>
            </div>
          </div>
      ...
      <div className="fs-modal-footer">
        ...
        >
          {importing ? "Importing…" : `Import ${validCount} Juror${validCount !== 1 ? "s" : ""}`}
        </button>
      </div>
    </Modal>
  );
