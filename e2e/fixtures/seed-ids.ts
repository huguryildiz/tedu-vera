 ...
 * All IDs here refer to rows in the demo Supabase database that are
 * emitted by `scripts/generate_demo_seed.js` in its dedicated
 * "E2E TEST FIXTURES" block (search for "E2E TEST FIXTURES" in that
 * script). Edit this file together with the generator block whenever
 * fixtures change.
 */
...
// ── Evaluation periods ──────────────────────────────────────────────────────
/** Active evaluation period for jury evaluate tests (under E2E_PERIODS_ORG_ID) */
export const EVAL_PERIOD_ID = "a0d6f60d-ece4-40f8-aca2-955b4abc5d88";

/** Period used by criteria + pin-blocking tests (under E2E_CRITERIA_ORG_ID) */
export const E2E_CRITERIA_PERIOD_ID = "cccccccc-0004-4000-c000-000000000004";

/** Period used by outcomes tests (under E2E_CRITERIA_ORG_ID) */
...
/** Juror used to test PIN lockout in pin-blocking spec (under E2E_PERIODS_ORG_ID, with locked juror_period_auth row) */
