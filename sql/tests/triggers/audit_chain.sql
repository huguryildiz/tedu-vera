...
-- ─────────────────────────────────────────────────────────────────────────
-- 4. _audit_verify_chain_internal returns empty array for org A (chain intact).
-- ─────────────────────────────────────────────────────────────────────────
SELECT is(
  _audit_verify_chain_internal('11110000-0000-4000-8000-000000000001'::uuid),
  '[]'::jsonb,
  '_audit_verify_chain_internal returns [] for org A (chain intact)'
);
